import WishListItemRow from '@/components/Store/WishListItem/WishListItem';
import { useTheme } from '@/hooks/System/useThemedBackground';
import { getWishlist, toggleWishlist } from '@/tools/store';
...
export default function CartScreen() {
  ...
  async function deleteItem(item: WishlistItem) {
    const res = await toggleWishlist(item.product.id);
